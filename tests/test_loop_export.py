...
def test_loop_export_builds_supported_and_proposed_artifacts(tmp_path: Path) -> None:
    ...
    _write_run(
        ...
        m5_detail_header="ticker,strategy,direction,entry_buffer_minutes,entry_window_minutes,regime_timeframe,evaluation_window,execution_profile,stress_profile,selected_ratio,holdout_trades,holdout_win_rate,base_exp_r,trades,mc_exp_r_mean,mc_exp_r_p05,mc_exp_r_p50,mc_exp_r_p95,mc_prob_positive_exp,mc_total_r_p05,mc_total_r_p50,mc_total_r_p95,mc_max_dd_p50,structure,dte,delta_plan,entry_window_et,profit_take,risk_rule\n",
    ...
    assert "evaluation_window" not in market_candidate["manifest"]["strategy"]["params"]
